package com.example.futbolfit.firebaseDatabase

import android.util.Log
import com.example.futbolfit.model.*
import com.example.futbolfit.util.Constants.Companion.ADDRESS_COLLECTION
import com.example.futbolfit.util.Constants.Companion.BEST_DEALS
import com.example.futbolfit.util.Constants.Companion.CART_COLLECTION
import com.example.futbolfit.util.Constants.Companion.CATEGORIES_COLLECTION
import com.example.futbolfit.util.Constants.Companion.CATEGORY
import com.example.futbolfit.util.Constants.Companion.CLOTHES
import com.example.futbolfit.util.Constants.Companion.COLOR
import com.example.futbolfit.util.Constants.Companion.CUPBOARD_CATEGORY
import com.example.futbolfit.util.Constants.Companion.ID
import com.example.futbolfit.util.Constants.Companion.ORDERS
import com.example.futbolfit.util.Constants.Companion.ORDER_PLACED_STATE
import com.example.futbolfit.util.Constants.Companion.PRICE
import com.example.futbolfit.util.Constants.Companion.PRODUCTS_COLLECTION
import com.example.futbolfit.util.Constants.Companion.QUANTITY
import com.example.futbolfit.util.Constants.Companion.SIZE
import com.example.futbolfit.util.Constants.Companion.STORES_COLLECTION
import com.example.futbolfit.util.Constants.Companion.TITLE
import com.example.futbolfit.util.Constants.Companion.USERS_COLLECTION
